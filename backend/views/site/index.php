        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="#" class="small-box-footer">
                        员工列表 <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <!-- ./col -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="chart">
                            <canvas id="lineChart" style="height: 250px;" height="271" width="604"></canvas>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="chart">
                            <canvas id="areaChart" style="height: 249px; width: 554px;" height="271" width="604"></canvas>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="chart">
                            <canvas id="lineChart2" style="height: 249px; width: 554px;" height="271" width="604"></canvas>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
